...
namespace AUPS_Backend.Migrations
{
    ...
    [Migration("20231210000135_object_of_labor_material")]
    partial class object_of_labor_material
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AUPS_Backend.Entities.OrganizationalUnit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrganizationalUnitId = new Guid("c02a3f87-178e-4d60-95ed-910ca9771599"),
            ...
            modelBuilder.Entity("AUPS_Backend.Entities.Workplace", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            WorkplaceId = new Guid("a47f938d-864f-4a7c-ac76-3b4ef51cf191"),
                            WorkplaceName = "Admin"
                        },
                        new
                        {
                            WorkplaceId = new Guid("130b3a11-28d7-4b28-90c8-885625e6bde0"),
                            WorkplaceName = "Menadzer"
                        },
                        new
                        {
                            WorkplaceId = new Guid("f234daff-ba8b-4c88-995e-84f1bfbd29c1"),
